...
public class ResourceAction {
    ...
    public @ResponseBody
    Result<Privilege> load(@PathVariable Long id) {
    ...
    public @ResponseBody
    Result create(@RequestBody Privilege privilege) {
        try {
    ...
    @RequestMapping(value = "/init/module/{id}", method = {RequestMethod.POST})
    public @ResponseBody
    Result initModule(@PathVariable Long id) {
        Privilege module = (Privilege) resourceService.load(id);
    ...
    public @ResponseBody
    Result updateModule(@PathVariable Long id, @RequestBody Privilege module) {
        module.setId(id);
        module.setDtype(Module.class.getSimpleName());
        resourceService.updateIgnoreNull(module);
        return new Result("保存成功!");

    }

    @RequestMapping(value = "/privilege/{id}", method = {RequestMethod.PUT})
    public @ResponseBody
    Result updatePrivilege(@PathVariable Long id, @RequestBody Privilege privilege) {
        privilege.setId(id);
    ...
    @RequestMapping("/read")
    public @ResponseBody
    List<ResourceVo> read(Long id, Long roleId, HttpServletRequest request, Model model) {
