...
<body>
	<div class="conte">
		<form id="mail_mail_form"
			action="${basePath}/mail/mailAction/schedule_send.json" method="post">
			<input type="hidden" id="mail_id" name="id" value="${mail.id }" />
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="col-md-12 col-xs-12 noPadding">
						<div class="form-group">
							<label class="col-xs-2 noPadding">发送时间<span class='red'>*</span>
								:
							</label>
							<div class="col-xs-10 noPadding">
								<input type="text" id="to" maxlength="255" name="date" value=""
					...
					<div class="col-md-12 col-xs-12 noPadding">${mail.content }</div>
				</div>
			</div>
