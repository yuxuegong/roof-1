...
@Controller
@RequestMapping("${actionName}Action")
public class ${alias?cap_first}Action {
	...
	public String index() {
		return "/crm/${sysName}/${alias}/${alias}_index.jsp";
	}
	...
	public String list(${alias?cap_first} ${alias}, HttpServletRequest request, Model model) {
		...
		return "/crm/${sysName}/${alias}/${alias}_list.jsp";
	}
	...
	public String create_page(Model model) {
		...
		this.loadCommon(model);
		return "/crm/${sysName}/${alias}/${alias}_create.jsp";
	}
	...
	public String update_page(${alias?cap_first} ${alias}, Model model) {
		...
		model.addAttribute("${alias}", ${alias});
		this.loadCommon(model);
		return "/crm/${sysName}/${alias}/${alias}_update.jsp";
	}
	...
	public String detail_page(${alias?cap_first} ${alias}, Model model) {
		...
		model.addAttribute("${alias}", ${alias});
		this.loadCommon(model);
		return "/crm/${sysName}/${alias}/${alias}_detail.jsp";
	}
