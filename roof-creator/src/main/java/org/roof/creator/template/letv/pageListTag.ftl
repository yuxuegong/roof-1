		...
		<div class="col-xs-12 main">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<form id="${sysName}_${alias}_search_form" method="post" action="${includeBase}/letv/gcr/${actionName}Action/list.action">
						...
						<div class="section row">
							...
							<div class="col-md-2 col-xs-12 noPadding">
								<div class="form-group">
									<input type="submit" value="查询" class="btn btn-primary btn-sm btn-block">
								</div>
							</div>
						</div>
					</form>
					...
					<div class="section row">
						<div class=" well well-sm" style="margin-bottom: 0; background: #ffffff; border: 0;">
							<a id="${sysName}_${alias}_detail_btn" class="btn btn-sm btn-primary" href="javascript:void(0)"> 
								<span class="glyphicon glyphicon-list-alt"></span> 查看
							</a> 
							<a id="${sysName}_${alias}_create_btn" class="btn btn-sm btn-primary" href="javascript:void(0)"> 
								<span class="glyphicon glyphicon-plus"></span> 新建
							</a> 
							<a id="${sysName}_${alias}_update_btn" class="btn btn-sm btn-primary" href="javascript:void(0)"> 
								<span class="glyphicon glyphicon-edit"></span> 修改
							</a> 
							<a id="${sysName}_${alias}_delete_btn" class="btn btn-sm btn-primary" href="javascript:void(0)"> 
								<span class="glyphicon glyphicon-remove"></span> 删除
							</a>
						</div>
					</div>
					<div class="table-responsive">
						<table class="table table-hover table-condensed" id="${sysName}_${alias}_table">
							<thead>
								<tr class='active'>
									<th>选择</th> 
									<#list fields as field> 
