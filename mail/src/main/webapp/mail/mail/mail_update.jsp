...
<title>修改t_mail信息</title>
<%@include file="/head_boot.jsp"%>
<script type="text/javascript" src="${basePath}/mail/mail/mail_update.js"></script>
</head>
<body>
<div class="conte">
		<form id="mail_mail_form" action="${basePath}/mail/mailAction/update.json" method="post">
  ...
  <div class="container text-center form-group">
    ...
    <div class="col-xs-6 col-md-2"><a id="mail_mail_update_close_btn" href="javascript:void(0)" class="btn btn-default btn-block">取消</a></div>
  </div>
  </form>
</div>
</body>
